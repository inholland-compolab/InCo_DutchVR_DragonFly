...
public class MegaFlowFLW
{
	...
	static Vector3 ReadV3(string[] vals)
	{
		...
		v.x = float.Parse(vals[index++], System.Globalization.CultureInfo.InvariantCulture);
		v.y = float.Parse(vals[index++], System.Globalization.CultureInfo.InvariantCulture);
		v.z = float.Parse(vals[index++], System.Globalization.CultureInfo.InvariantCulture);
